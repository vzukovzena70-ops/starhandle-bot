...
# ВЕРСИЯ: 8.3 (С ПЕРЕМЕННОЙ ОКРУЖЕНИЯ)
# ============================================

import os  # <--- ДОБАВЛЕНО ДЛЯ ТОКЕНА
import asyncio
import json
import random
import string
...
# ==================== ТОКЕН (БЕРЁТСЯ ИЗ ПЕРЕМЕННОЙ НА СЕРВЕРЕ) ====================
TOKEN = os.getenv("BOT_TOKEN")  # ТЕПЕРЬ ТОКЕН СПРЯТАН!

if not TOKEN:
    raise ValueError("❌ Токен не найден! Добавь переменную BOT_TOKEN на сервере!")
